...
public class EJ5 {
    public static void main(String[] args) {
        ...
        do {
            franja = IOManager.leerEntero("Introduzca número de franjas donde quiere reservar [1-6]");
        ...
        dni = IOManager.leerCadena("Introduce dni:");
        System.out.println("EL dni es: " + dni + " está disponible " + disponible);
    }
}
